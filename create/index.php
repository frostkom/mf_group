							...
							<div class='inside'>"
								...
								{*/
									echo "<div class='display_acceptance_message'>"
										.show_textfield(array('name' => 'strGroupAcceptanceSubject', 'text' => __("Subject", $obj_group->lang_key), 'value' => $obj_group->acceptance_subject, 'placeholder' => sprintf(__("Accept subscription to %s", $obj_group->lang_key), $obj_group->name)))
									...
									{*/
										echo "<div class='display_reminder_message'>
											<h3>".__("Reminder if the recipient has not yet accepted", $obj_group->lang_key)."</h3>"
						...
						<div class='inside'>";
							...
							{*/
								echo "<div class='display_registration_fields'>"
									.show_select(array('data' => get_yes_no_for_select(), 'name' => 'strGroupVerifyAddress', 'text' => __("Verify that address is in Address book", $obj_group->lang_key), 'value' => $obj_group->verify_address));
